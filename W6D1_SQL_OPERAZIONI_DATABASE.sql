...
SELECT  ProductKey, ModelName, EnglishProductName, StandardCost, ListPrice, ProductAlternateKey FROM dimproduct WHERE ProductAlternateKey LIKE 'BK%' OR ProductAlternateKey LIKE 'FR%';
...
SELECT SalesOrderNumber, ProductKey, Orderdate, SalesAmount, SalesAmount - TotalProductCost AS Profit FROM factresellersales WHERE ProductKey IN (597,598,477,214) AND Orderdate > '2020-01-01';
